...
import LaserSlides.fragments.NetworkDialogFragment;
import LaserSlides.fragments.WifiSettingsDialogFragment;
...
public class QuickOSCActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        MenuItem editMenuItem = menu.getItem(2);
    ...
    private void showHelp(){
        Intent intent = new Intent(QuickOSCActivity.this, Help.class);
